...
const ListHeroCard = () => {
    ...
    const completedCount = items.filter(itme => itme.purchased).length
    ...
    return (
        <View className='rounded-3xl bg-primary p-5'>
            <Text className='text-sm font-semibold uppercase tracking-[1px] text-primary-foreground/70'>Your Shopping List</Text>
