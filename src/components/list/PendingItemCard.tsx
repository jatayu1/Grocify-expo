...
const priopityPillBg = {
    low: "bg-priority-low",
    medium: "bg-priority-medium",
    high: "bg-priority-high",
}

const priopityPillText = {
        ...
        <View className='flex-row items-start gap-3'>
            ...
            <View className="flex-1">
                <View className="flex-row items-center justify-between gap-2">
                    ...
                    <View className={`rounded-full px-3 py-1 ${priopityPillBg[item.priority]}`}>
                        <Text className={`text-xs font-bold uppercase ${priopityPillText[item.priority]}`}>
                            {item.priority}
                        </Text>
                    </View>
                </View>
