...
const priorities: GroceryPriority[] = [
    "high",
    "medium",
    "low"
]
const categoryIcons: Partial<Record<GroceryCategory, string>> = {
    Produce: "leaf",
    Dairy: "cow",
    Bakery: "bread-slice",
    Pantry: "box-open",
...
const PlannerFromCard = () => {
    ...
    const handelQuantityChange = (value: string) => {
    ...
    return (
        <View className="rounded-3xl border border-border bg-card p-4">
            <Text className='text-sm font-semibold text-foreground'>Add New Item</Text>
...
export default PlannerFromCard