...
import PlannerFromCard from '@/components/planner/PlannerFromCard';
...
const PlannerScreen = () => {
    ...
    const highestPriorityCount = items.filter((item) => !item.purchased && item.priority === 'high').length;
            ...
            <View className="gap-4 rounded-3xl border border-border bg-card/70 p-5">
                ...
                <View className="flex-row gap-2">
                    ...
                    <View className="flex-1 rounded-2xl border border-border bg-background/80 p-3">
                        ...
                        <Text className="mt-1 text-xl font-bold text-foreground">{highestPriorityCount}</Text>
                    </View>
