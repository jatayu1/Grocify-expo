    ...
    return (
        <SafeAreaView className='flex-1 bg-primary dark:bg-secondary' edges={["top"]}>
            ...
            <View className='px-6 pt-4'>
                <Text className='text-center text-5xl font-extrabold tracking-tight text-primaru-foreground uppercase font-mono dark:text-foreground'>Grocify</Text>

                <Text className='mt-1 text-center text-[14px] text-primary-foreground/80 dark:text-foreground/75'>Plan smarter. Shop happier.</Text>
            ...
            <View className='mt-8 flex-1 rounded-t-[36px] bg-card px-6 pb-8 pt-6'>
                <View className='self-center rounded-full bg-secondary px-3 py-1 text-secondary-foreground'>
                    <Text className='text-xs font-semibold uppercase tracking-[1px] text-secondary-foreground'>Welcome Back</Text>
                </View>

                <Text className='mt-2 text-center text-sm lending-6 text-muted-foreground'>Choose a social provider and jump right into your personalized grocery experience.</Text>
                ...
                <View className='mt-6'>
                    ...
                    <Pressable
                        className={`mb-3 h-14 flex-row items-center rounded-2xl border border-border bg-card px-4 active:opacity-90 ${isGithubClicked ? "opacity-70" : ""}`}
                    ...
                    <Pressable
                        className={`mb-3 h-14 flex-row items-center rounded-2xl border border-foreground bg-foreground px-4 active:opacity-90 ${isAppleClicked ? "opacity-70" : ""}`}
                        ...
                        <Text className='ml-3 flex-1 text-lg font-semibold text-card-background'>
